...
#define FTS_ASSERT_MSG(x, msg) do{\
    if(!(x))\
    {\
...
#define FTS_ASSERT_MSG(x, msg) do { (void)sizeof(x), (void)sizeof(msg); } while(0)
#define FTS_ASSERT(x) do { (void)sizeof(x); } while(0) //noop
