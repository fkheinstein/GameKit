...
#define FTS_CORE_ERROR(...)  {  ::fts::Log::GetCoreLogger()->error(__VA_ARGS__) ; ::fts::Log::GetClientLogger()->error("Location: \n{}", ::fts::Log::DumpStackTrace()); }
#define FTS_CORE_CRITICAL(...) { ::fts::Log::GetCoreLogger()->critical(__VA_ARGS__) ; ::fts::Log::GetClientLogger()->critical("Location: \n{}", ::fts::Log::DumpStackTrace()); }
...
#define LOG_ERROR(...)  {       ::fts::Log::GetClientLogger()->error(__VA_ARGS__); ::fts::Log::GetClientLogger()->error("Location: \n{}", ::fts::Log::DumpStackTrace()); }
#define LOG_CRITICAL(...)   {   ::fts::Log::GetClientLogger()->critical(__VA_ARGS__); ::fts::Log::GetClientLogger()->critical("Location: \n{}", ::fts::Log::DumpStackTrace()); }
