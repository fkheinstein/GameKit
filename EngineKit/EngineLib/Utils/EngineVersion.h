#ifndef __ENGINEVERSION_H__
#define __ENGINEVERSION_H__
...
namespace fts
{
    ...
    public:
        ...
        inline VersionInfo(int major, int minor, int patch, std::string extra)
            : major_(major), minor_(minor), patch_(patch), extra_(extra) { }
        ...
        */
        ...
        inline int getPatch()         const { return patch_; }
        inline std::string getExtra() const { return extra_; }
