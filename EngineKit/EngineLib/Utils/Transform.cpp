...
namespace fts
{
    ...
    Transform::Transform() : m_position(0.f), m_rotation(1.f, 0.f, 0.f, 0.f), m_scale(1.0f)
    {
    }
    ...
    {
        return glm::translate(Matrix4f(1.0f), m_position) * Matrix4f(m_rotation) * glm::scale(Matrix4f(1.0f), m_scale);
    }
