...
namespace fts
{
    ...
    public:
        ...
        void SetPixels(int x, int y, int z, int width, int height, int depth,  const void* data) override;
        ...
        void ReadPixels(int level, int x, int y, int z, int w, int h, int d, size_t size, void* data) const override;
