...
#include "Graphics/OpenGL/GLShaderParam.h"
...
namespace fts
{
    ...
    ShaderParam* GLShader::GetParam(int32_t index)
    {
        ...
        if (type == UniformType::Unknown) {
            FTS_CORE_ERROR("Unknown shader uniform type:{} for uniform:\"{}\"!",
                gl_type, s);
            return nullptr;
        }
    ...
    void GLShader::CompileShader(ShaderType type, const std::string& code)
    {
        ...
        case ShaderType::Invalid:
            FTS_CORE_ERROR("Trying to add a invalid shader");
            break;
        }
    }
    ...
    void GLShader::CheckCompileErrors(uint32_t shader, const std::string& type)
    {
        ...
        FTS_ASSERT_MSG(success, infoLog.c_str());
    }
    ...
    glm::ivec3 GLShader::GetLocalGroupSize() const
    {
