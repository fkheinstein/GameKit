...
namespace fts
{
    ...
    void CascadeShadow::CreateShadowMap(int32_t width, int32_t height)
    {
        ...
        m_cascade_map = Texture::Create(m_width, m_height, m_cascade_planes.size(), MultiSampleLevel::None, TextureType::Array, DataFormat::Depth24);
    ...
    static glm::mat4 GetLightSpaceMatrix(const Transform& transform, const glm::mat4& projection_view)
    {
        /* glm::vec3 center(0);
         ...
         const auto light_view =   glm::lookAt(center - transform.GetFront(), center, transform.GetUp());
