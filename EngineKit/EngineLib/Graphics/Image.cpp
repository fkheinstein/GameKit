...
namespace fts
{
    ...
    void ByteImage::GetPixels(int32_t x, int32_t y, int32_t width, int32_t height,  uint8_t *value) const
    {
    ...
    void ByteImage::SetPixels(int32_t x, int32_t y, int32_t width, int32_t height,  uint8_t *value)
    {
        const size_t pitch = width * m_channels;
        for (; height > 0; --height)
        {
